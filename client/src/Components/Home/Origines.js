          ...
          <Slide direction="right" triggerOnce>
            <div className="description">
              ...
              <p>
                ...
                heritage list for its cultural value and power in social
                cohesion. Spend less time searching for rumba music online and
                more time enjoying high-quality, handpicked tracks covering
                every mood and genre.
              </p>
            ...
            <Slide cascade direction="up" triggerOnce>
              ...
              <div className="concert concert-location3">
                <h1>
                  {" "}
                  <a
                    href="https://en.wikipedia.org/wiki/Accor_Arena"
                    target="/"
                  >
                    Accor Arena
                  </a>
